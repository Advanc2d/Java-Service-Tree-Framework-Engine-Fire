...
import com.arms.jira.jirapriority.strategy.온프라미스_지라_이슈_우선순위_전략;
...
public class 지라_이슈_우선순위_전략_호출 {
    ...
    온프라미스_지라_이슈_우선순위_전략 온프라미스_지라_이슈_우선순위_전략;
    ...
    public 지라_이슈_우선순위_전략_호출(지라_이슈_우선순위_전략_등록_및_실행 지라_이슈_우선순위_전략_등록_및_실행,
        ...
        this.온프라미스_지라_이슈_우선순위_전략 = 온프라미스_지라_이슈_우선순위_전략;
    ...
    private 지라_이슈_우선순위_전략_등록_및_실행 지라_이슈_우선순위_전략_확인(JiraInfoDTO 연결정보) {
        ...
        if (연결정보.getType().equals("클라우드")) {
            ...
            지라_이슈_우선순위_전략_등록_및_실행.지라_이슈_우선순위_전략_등록(온프라미스_지라_이슈_우선순위_전략);
        }
