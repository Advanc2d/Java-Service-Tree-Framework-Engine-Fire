...
public class 지라_이슈_유형_컨트롤러 {
    ...
    public List<지라_이슈_유형_데이터_전송_객체> 온프레미스_이슈_유형_목록_가져오기(@PathVariable("connectId") Long 연결_아이디,
    ...
    public List<지라_이슈_유형_데이터_전송_객체> 클라우드_프로젝트별_이슈_유형_목록_가져오기(@PathVariable("connectId") Long 연결_아이디,
                                                                        @PathVariable("projectId") String 프로젝트_아이디,
                                                                ModelMap model, HttpServletRequest request) throws Exception {
        로그.info("지라 프로젝트별_이슈_유형_목록_가져오기");

        return 지라_이슈_유형_전략_호출.프로젝트별_이슈_유형_목록_가져오기(연결_아이디, 프로젝트_아이디);
    }
}
