...
public class 지라_이슈_유형_전략_등록_및_실행 {
    ...
    public List<지라_이슈_유형_데이터_전송_객체> 이슈_유형_목록_가져오기(Long 연결_아이디) throws URISyntaxException, IOException, ExecutionException, InterruptedException {
        return this.지라_이슈_유형_전략.이슈_유형_목록_가져오기(연결_아이디);
    }

    public List<지라_이슈_유형_데이터_전송_객체> 프로젝트별_이슈_유형_목록_가져오기(Long 연결_아이디, String 프로젝트_아이디) throws URISyntaxException, IOException, ExecutionException, InterruptedException {
        return this.지라_이슈_유형_전략.프로젝트별_이슈_유형_목록_가져오기(연결_아이디, 프로젝트_아이디);
    }
