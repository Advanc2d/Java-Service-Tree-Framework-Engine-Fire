...
import com.arms.jira.jiraproject.strategy.온프라미스_지라_프로젝트_전략;
...
public class 지라_프로젝트_전략_교체 {
    지라_프로젝트_전략_등록_및_실행 지라_프로젝트_전략_등록_및_실행;

    클라우드_지라_프로젝트_전략 클라우드_지라_프로젝트_전략;

    온프라미스_지라_프로젝트_전략 온프라미스_지라_프로젝트_전략;

    JiraInfo jiraInfo;

    @Autowired
    public 지라_프로젝트_전략_교체(지라_프로젝트_전략_등록_및_실행 지라_프로젝트_전략_등록_및_실행,
                         클라우드_지라_프로젝트_전략 클라우드_지라_프로젝트_전략,
                         온프라미스_지라_프로젝트_전략 온프라미스_지라_프로젝트_전략,
                         JiraInfo jiraInfo) {
        ...
        this.온프라미스_지라_프로젝트_전략 = 온프라미스_지라_프로젝트_전략;
    ...
    private 지라_프로젝트_전략_등록_및_실행 지라_프로젝트_전략_확인(JiraInfoDTO 연결정보) {
        ...
        if (연결정보.getType().equals("클라우드")) {
            ...
            지라_프로젝트_전략_등록_및_실행.지라_프로젝트_전략_등록(온프라미스_지라_프로젝트_전략);
        }
