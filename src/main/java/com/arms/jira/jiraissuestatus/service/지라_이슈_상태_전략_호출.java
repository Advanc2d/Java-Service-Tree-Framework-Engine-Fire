...
public class 지라_이슈_상태_전략_호출 {
    ...
    private 지라_이슈_상태_전략_등록_및_실행 지라_이슈_상태_전략_확인(JiraInfoDTO 연결정보) throws Exception {
        ...
        if(연결정보 == null || 연결정보.getType().isEmpty()) {
            throw new IllegalArgumentException("연결정보의 유형이 지정되어있지 않습니다.");
        }
    ...
    public List<지라_이슈_상태_데이터_전송_객체> 이슈_상태_목록_가져오기(Long 연결_아이디) throws Exception {
        ...
        List<지라_이슈_상태_데이터_전송_객체> 반환할_지라_이슈_상태_데이터전송객체_목록
                = 지라_이슈_상태_전략_등록_및_실행.이슈_상태_목록_가져오기(연결_아이디);
    ...
    public List<지라_이슈_상태_데이터_전송_객체> 프로젝트별_이슈_상태_목록_가져오기(Long 연결_아이디, String 프로젝트_아이디) throws Exception {
        ...
        if (지라_유형 == 지라_유형_정보.온프레미스) {
            /* ***
             *  에러처리 수정사항, 온프라미스 타입은 프로젝트별 이슈 유형 목록 가져오기 안 됨
             *** */
        ...
        List<지라_이슈_상태_데이터_전송_객체> 반환할_지라_이슈_상태_데이터전송객체_목록
                = 지라_이슈_상태_전략_등록_및_실행.프로젝트별_이슈_상태_목록_가져오기(연결_아이디, 프로젝트_아이디);
