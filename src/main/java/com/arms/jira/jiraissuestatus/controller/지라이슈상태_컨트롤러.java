...
public class 지라이슈상태_컨트롤러 {
    ...
    public List<지라이슈상태_데이터> 온프레미스_이슈_상태_목록_가져오기(@PathVariable("connectId") Long 연결_아이디,
                                                ModelMap model, HttpServletRequest request) throws Exception {
        로그.info("이슈 상태 리스트 조회");
        return 지라이슈상태_전략_호출.이슈_상태_목록_가져오기(연결_아이디);
    }
    ...
    public List<지라이슈상태_데이터> 클라우드_프로젝트별_이슈_상태_목록_가져오기(@PathVariable("connectId") Long 연결_아이디,
                                                     @PathVariable("projectId") String 프로젝트_아이디,
                                                     ModelMap model, HttpServletRequest request) throws Exception {
        로그.info("클라우드_프로젝트별_이슈_상태_목록_가져오기");

        return 지라이슈상태_전략_호출.프로젝트별_이슈_상태_목록_가져오기(연결_아이디, 프로젝트_아이디);
    }
}
