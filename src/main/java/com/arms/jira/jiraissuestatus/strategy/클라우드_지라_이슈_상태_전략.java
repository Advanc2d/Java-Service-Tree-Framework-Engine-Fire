...
public class 클라우드_지라_이슈_상태_전략 implements 지라_이슈_상태_전략 {
    ...
    public List<지라_이슈_상태_데이터_전송_객체> 이슈_상태_목록_가져오기(Long 연결_아이디) throws Exception{
        ...
        while(!checkLast) {
            ...
            클라우드_지라_이슈_상태_전체_데이터_전송_객체 지라_이슈_상태_조회_결과 = 지라유틸.get(webClient, endpoint, 클라우드_지라_이슈_상태_전체_데이터_전송_객체.class).block();
    ...
    public List<지라_이슈_상태_데이터_전송_객체> 프로젝트별_이슈_상태_목록_가져오기(Long 연결_아이디, String 프로젝트_아이디) throws Exception{
        ...
        while(!checkLast) {
            String endpoint = "/rest/api/3/statuses/search?최대_검색수="+ 최대_검색수 + "&startAt=" + startAt + "&projectId="+프로젝트_아이디;
            클라우드_지라_이슈_상태_전체_데이터_전송_객체 지라_이슈_상태_조회_결과 = 지라유틸.get(webClient, endpoint, 클라우드_지라_이슈_상태_전체_데이터_전송_객체.class).block();
