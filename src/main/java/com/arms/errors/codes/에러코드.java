...
public enum 에러코드 {
    ...
    서버정보_오류("JiraInfo 정보가 없습니다."),
    서버정보_URI_오류("JiraInfo의 URI 정보가 없습니다."),
    서버정보_ID_오류("JiraInfo의 사용자 아이디 정보가 없습니다."),
    서버정보_PW_오류("JiraInfo의 비밀번호나 토큰 정보가 없습니다."),
    서버정보_TYPE_오류("JiraInfo의 타입 정보가 없습니다."),
